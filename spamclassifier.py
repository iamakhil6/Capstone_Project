...
class SpamClassifier:
    ...
    def extract_features(self, document):
        ...
        """
        #  1. use this when you are passing string as i/p

        # d = {word: word in nltk.word_tokenize(document) for word in self.unique_data}

        #  2. uncomment when you are passing tokenized data as i/p
    ...
    def train(self, text, labels):
        ...
        """
        # 1. Passing email as String to extract_features
        ...
        # 2. Passing tokenized string as i/p to extract_features function below code works faster
